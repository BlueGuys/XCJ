...
import com.hongyan.xcj.modules.coin.bean.DataParse;
import com.hongyan.xcj.modules.coin.bean.KLineBean;
import com.hongyan.xcj.modules.coin.bean.KMAEntity;
import com.hongyan.xcj.modules.coin.bean.VMAEntity;
import com.hongyan.xcj.modules.coin.common.ConstantTest;
import com.hongyan.xcj.modules.coin.mychart.CoupleChartGestureListener;
import com.hongyan.xcj.modules.coin.mychart.MyBottomMarkerView;
import com.hongyan.xcj.modules.coin.mychart.MyCombinedChart;
import com.hongyan.xcj.modules.coin.mychart.MyHMarkerView;
...
public class CoinDetail2Activity extends BaseActivity {
...
//        axisLeftVolume.setSpaceBottom(0);//距离顶部留白
    ...
    private void setMarkerViewButtom(DataParse mData, MyCombinedChart combinedChart) {
        MyLeftMarkerView leftMarkerView = new MyLeftMarkerView(CoinDetail2Activity.this, R.layout.mymarkerview);
        MyHMarkerView hMarkerView = new MyHMarkerView(CoinDetail2Activity.this, R.layout.mymarkerview_line);
        MyBottomMarkerView bottomMarkerView = new MyBottomMarkerView(CoinDetail2Activity.this, R.layout.mymarkerview);
