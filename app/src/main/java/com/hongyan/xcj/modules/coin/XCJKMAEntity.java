...
public class XCJKMAEntity {
     ...
     * @param n         几日均值
     */
    public XCJKMAEntity(ArrayList<CoinResult.KLineBean> kLineBeen, int n) {
     ...
     */
    public XCJKMAEntity(ArrayList<CoinResult.KLineBean> kLineBeen, int n, float defult) {
    ...
    private static float getSum(Integer a, Integer b, ArrayList<CoinResult.KLineBean> datas) {
        float sum = 0;
        for (int i = a; i <= b; i++) {
    ...
    public static float getLastMA(ArrayList<CoinResult.KLineBean> datas, int n) {
