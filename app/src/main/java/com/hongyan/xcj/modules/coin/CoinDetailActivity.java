...
//        axisLeftVolume.setSpaceBottom(0);//距离顶部留白
    ...
    private void setMarkerViewButtom(DataParse mData, MyCombinedChart combinedChart) {
        MyLeftMarkerView leftMarkerView = new MyLeftMarkerView(CoinDetailActivity.this, R.layout.mymarkerview);
        MyHMarkerView hMarkerView = new MyHMarkerView(CoinDetailActivity.this, R.layout.mymarkerview_line);
        MyBottomMarkerView bottomMarkerView = new MyBottomMarkerView(CoinDetailActivity.this, R.layout.mymarkerview);
