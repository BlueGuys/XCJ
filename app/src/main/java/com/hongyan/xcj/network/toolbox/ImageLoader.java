...
import com.hongyan.xcj.network.Response.ErrorListener;
import com.hongyan.xcj.network.Response.Listener;
...
public class ImageLoader {
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight,
        ...
        return new com.hongyan.xcj.network.toolbox.ImageRequest(requestUrl, new Listener<Bitmap>() {
            @Override
